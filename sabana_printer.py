...
#
# Description: After a robot has been loaded, this will execute a series of trajectories for printing mode.
...
class PublisherJointTrajectory(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            'Publicando {} puntos de impresión, en el topic "{}" cada {} s'.format(
    ...
    def seguimiento_datos(self):
        # CAMBIO DE PUNTO A PUNTO --------------------------
        print('\033[44m' +'CAMBIO'+ '\033[0m')
        print("PL: "+str(self.i))
        print("PG: "+str(self.j))
        print("_________________")


    def reiniciar_yaml(self):

        goal_names = self.get_parameter("goal_names").value
        if self.i >=len(goal_names)-1: # El -1 consiste en que el driver evita el último punto, se compara con el penúltimo y se duplica en el archivo txt.
             
             print("reiniciando")
             print('\033[44m' +'SIGUIENTE PARTE'+ '\033[0m')

             os.system("ros2 launch ur_bringup square_printer.launch.py")
             try:
                main()
             except: 
                print(exit) 
    ...
    def timer_callback(self):  #función para callback.
        ...
        if self.starting_point_ok:
            ...
            self.j += 1
            inicio = (contador * 500) - 500
            self.j=inicio+self.i
